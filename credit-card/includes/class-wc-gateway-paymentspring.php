<?php
  ...
  class WC_Gateway_PaymentSpring extends WC_Payment_Gateway_CC{
    ...
    public function payment_scripts(){
      ...
      wp_enqueue_script('paymentspring_js_api', plugins_url('assets/js/paymentspring.js', PAYMENT_SPRING_WC_BASE_FILE), array(), PAYMENT_SPRING_PLUGIN_VERSION);
      wp_enqueue_script('paymentspring_woocommerce', plugins_url('assets/js/paymentspring-form.js', PAYMENT_SPRING_WC_BASE_FILE), array(), PAYMENT_SPRING_PLUGIN_VERSION);
      ...
      wp_localize_script('paymentspring_woocommerce', 'cc_settings_public_key', apply_filters('cc_settings_public_key', $apiKey));
    }
    ...
    public function process_payment( $order_id, $retry = true, $force_customer = false ) {
      ...
      if(!$this->keysAreSet){
        throw new Exception(
          __("Please set your API Keys in WooCommerce > Settings > Payments > PaymentSpring", 'paymentspring-woocommerce-gateway')
        );
      }
    ...
    public function process_refund($orderId, $amount = null, $reason = '') {
      $chargeId = get_post_meta( $orderId, '_paymentspring_charge_id', true );
